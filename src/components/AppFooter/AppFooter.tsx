...
const AppFooter = () => {
  return (
    <footer className="mx-auto mt-36 w-full max-w-[85rem] border-t border-gray-200 px-4 py-10 pt-10 sm:px-6 lg:px-8 dark:border-neutral-700">
      {/*Grid*/}
            ...
            <div className="hs-dropdown relative inline-flex [--placement:top-left]">
              ...
              >
                ...
                >
                  ...
                  >
                    <defs>
                      <path id="Link" fill="#ffde00" d="M1-.3L-.7.8 0-1 .6.8-1-.3z" />
                    </defs>
